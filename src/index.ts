...
import { SELF_ROUTE, withAnalytics, tagRequest, recordProtocolMethods, sessionFromRequest, withSessionHeader } from "./analytics.js";
...
export default {
  async fetch(request: Request, env: Env, ctx: ExecutionContext): Promise<Response> {
    ...
    // Recibo do hook de tools: o que ele gravar nesta requisicao fica aqui, e e
